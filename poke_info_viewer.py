...
enter_name.grid(row=0, column=1, padx=(10, 5), pady=10)
...
btn_get_info = ttk.Button(frm_input, text='Get Information', command=handle_btn_get_info)
...
lbl_height.grid(row=0, column=0, sticky="E", padx=(10, 5), pady=(10, 5))
lbl_height_val = ttk.Label(frm_info, width=20)
lbl_height_val.grid(row=0, column=1, sticky="W", padx=(5, 10), pady=(10, 5))

lbl_weight = ttk.Label(frm_info, text="Weight:")
lbl_weight.grid(row=1, column=0, sticky="E", padx=(10, 5), pady=5)
lbl_weight_val = ttk.Label(frm_info, width=20)
lbl_weight_val.grid(row=1, column=1, sticky="W", padx=(5, 10), pady=5)

lbl_type = ttk.Label(frm_info, text="Type:")
lbl_type.grid(row=2, column=0, sticky="E", padx=(10, 5), pady=(5, 10))
lbl_type_val = ttk.Label(frm_info, width=20)
lbl_type_val.grid(row=2, column=1, sticky="W", padx=(5, 10), pady=(5, 10))
